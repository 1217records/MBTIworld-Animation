...
export default function ResultShareClientEn({ themeId, type, shareUrl, imageUrl }: ResultShareClientProps) {
  ...
  const handleKakaoShare = () => {
    if (typeof window === "undefined" || !window.Kakao) {
      alert("Loading Kakao SDK. Please try again in a moment.");
      return;
    }
    ...
    try {
      ...
      alert("Kakao sharing failed. Please copy the link and share it.");
    }
  };
  ...
  return (
    <section className="bg-white rounded-[4rem] p-8 sm:p-20 border border-gray-100 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.08)] space-y-12 text-center">
      ...
      <div className="space-y-2">
        <h3 className="text-2xl font-black font-serif text-[#16324f]">Share Your Result</h3>
        <p className="text-gray-400 font-medium text-sm">Show your character match to friends.</p>
      </div>
