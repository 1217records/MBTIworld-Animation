...
export default function ResultShareClientJa({ themeId, type, shareUrl, imageUrl }: ResultShareClientProps) {
  ...
  const handleKakaoShare = () => {
    if (typeof window === "undefined" || !window.Kakao) {
      alert("Kakao SDKを読み込み中です。しばらくして再試行してください。");
      return;
    }
  ...
  return (
    <section className="bg-white rounded-[4rem] p-8 sm:p-20 border border-gray-100 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.08)] space-y-12 text-center">
      ...
      <div className="space-y-2">
        <h3 className="text-2xl font-black font-serif text-[#16324f]">結果をシェア</h3>
        <p className="text-gray-400 font-medium text-sm">友達にあなたのキャラクターマッチを共有しましょう。</p>
      </div>
