...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // In a real app, you'd send this to an API or Formspree
    setSubmitted(true);
  };
  ...
  return (
    <div className="max-w-xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-xl space-y-6">
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <textarea 
              required
              rows={4}
              placeholder="예: 진격의 거인 인물들로 MBTI 테스트 만들어주세요!"
        ...
        <button 
          type="submit"
          className="w-full py-4 rounded-2xl bg-[#16324f] text-white font-bold text-lg shadow-lg hover:brightness-110 transition-all active:scale-95"
        >
          제안 보내기
        </button>
      </form>
